...
const DEFAULT_LIMITATION_MESSAGES: Record<string, string> = {
  gmail: "Gmail integration is currently unavailable. Email communications and lifecycle actions may be delayed.",
  hubspot: "HubSpot integration is currently unavailable. CRM data, campaign analytics, and lead management may be limited.",
  mailchimp: "Mailchimp integration is currently unavailable. Email campaign execution and audience sync may be affected.",
  googlesheets: "Google Sheets integration is currently unavailable. Spreadsheet-based reporting and experiment tracking may be delayed.",
};
...
function getAffectedWorkflows(toolkitId: string): string[] {
  ...
  return workflowMap[toolkitId] || ["General growth-revenue workflows"];
}
